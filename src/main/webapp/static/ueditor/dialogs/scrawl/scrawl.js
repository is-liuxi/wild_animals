        ...
        getCanvasData:function () {
            ...
            if (img) {
                ...
                if (img.style.position == "absolute") {
                    ...
                    y = parseInt(img.style.commonTop);
                } else {
...
(function () {
    ...
    ScaleBoy.prototype = {
        ...
        startScale:function (objElement) {
            ...
            Idom.style.cssText = 'visibility:visible;top:' + objElement.style.commonTop + ';left:' + objElement.style.left + ';width:' + objElement.offsetWidth + 'px;height:' + objElement.offsetHeight + 'px;';
        ...
        updateStyleByDir:function (dir, offset) {
            ...
            if (rect[dir][1] != 0) {
                ...
                dom.style.top = me._validScaledProp('commonTop.jsp', tmp) + 'px';
            }
            if (rect[dir][2] != 0) {
